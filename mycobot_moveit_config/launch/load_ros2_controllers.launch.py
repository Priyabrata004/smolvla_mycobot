...
# from launch.actions import WaitForService
...
def generate_launch_description():
    ...
    return LaunchDescription([
        TimerAction(period=15.0, actions=[start_joint_state_broadcaster_cmd]),
        TimerAction(period=18.0, actions=[start_arm_controller_cmd]),
        TimerAction(period=20.0, actions=[start_gripper_action_controller_cmd]),
    ])
